...
static const char *className = "com/example/hellojni/ReflectionHelper";
...
jstring nativeGetHelloString(JNIEnv *env, jobject obj) {
    return env->NewStringUTF((char *) " This is calling from JNI cpp!");
}
static JNINativeMethod gMethods[] = {
        {"helloLoad", "()Ljava/lang/String;", (void *) nativeGetHelloString},
};
