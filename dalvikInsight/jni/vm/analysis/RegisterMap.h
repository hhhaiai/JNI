 ...
 * Get the format.
 */
INLINE RegisterMapFormat

dvmRegisterMapGetFormat(const RegisterMap *pMap) {
...
dvmRegisterMapGetRegWidth(const RegisterMap *pMap) {
...
dvmRegisterMapGetNumEntries(const RegisterMap *pMap) {
...
INLINE const RegisterMap
*
dvmGetExpandedRegisterMap(Method
                          *method) {
    ...
    if (format == kRegMapFormatCompact8 || format == kRegMapFormatCompact16) {
        ...
        return
                dvmGetExpandedRegisterMap0(method);
    }
}
