...
static const char* className = "me/hhhaiai/jnicpp/HelloJni";
...
extern "C" {
	...
	jstring nativeGetHelloString(JNIEnv *env, jobject obj) {
		return env->NewStringUTF((char *) " jni form cpp!");
	}
	static JNINativeMethod gMethods[] = {
			{ "helloLoad", "()Ljava/lang/String;", (jstring *) nativeGetHelloString },
	};
